$(document).ready(function () {
    ...
    function weatherFunction(searchTerm) {
      ...
      $.ajax({
        type: "GET",
        url: "https://api.openweathermap.org/data/2.5/weather?q=" + searchTerm + "&appid=3c71e146acae833c878e6418b7536759",
        ...
        $.ajax({
          type: "GET",
          url: "https://api.openweathermap.org/data/2.5/uvi?appid=3c71e146acae833c878e6418b7536759&lat=" + lat + "&lon=" + lon,
    ...
    function weatherForecast(searchTerm) {
      $.ajax({
        type: "GET",
        url: "https://api.openweathermap.org/data/2.5/forecast?q=" + searchTerm + "&appid=3c71e146acae833c878e6418b7536759&units=imperial",
        ...
        for (var i = 0; i < data.list.length; i++) {if (data.list[i].dt_txt.indexOf("15:00:00") !== -1) {
